...
public class SecurityConfig {
    ...
    // 클라이 언트에서 http://localhost:8080/oauth2/authorization/kakao 클릭하면
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // 특정 URL에 인증없이 허용
                        .requestMatchers("/api/guestbook/detail/**", "api/guestbook/download/**", "/api/searchNews/**",
                        "api/guestbook/download/**", "/api/searchNews/**", "/api/phar_info/write/**", "/api/phar_info/detail/{phar_idx}",
                        "/api/phar_info/list"
                        )
                        .permitAll()
                        // 나머지는 인증 필요
